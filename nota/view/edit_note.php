...
<textarea name="content" class="form-control" cols="30" rows="5"><?php echo $content; ?></textarea>

</div>

<input type="submit" value="Guardar" class="mt-2 btn btn-primary" />

<a href="index.php?controller=note&action=list" class="mt-2 btn btn-outline-success">Cancelar</a>
